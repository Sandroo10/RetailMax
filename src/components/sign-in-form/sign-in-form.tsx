  ...
  const SignInForm: React.FC<SignInFormProps> = ({ onSuccess }) => {
    ...
    return (
        <div className="max-w-[500px] mx-auto">
            ...
            <h2>Don't Have one? <Link to='/auth' className="font-bold">Sign up</Link> Here </h2>   
            <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className=" flex flex-col items-center space-y-6 max-w-s *:w-full px-2 w-full dark:text-white">
